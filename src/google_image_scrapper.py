...
@author: OHyic
@git: https://github.com/ohyicong/Google-Image-Scraper
"""
import io
import os
import time
...
from helper import download_lastest_chromedriver
        ...
        while True:
            try:
                ...
                try:
                    ...
                    is_patched = download_lastest_chromedriver()
                else:
                    is_patched = download_lastest_chromedriver(driver.capabilities["version"])
                if not is_patched:
                    exit(
